...
<div class="nav">
    ...
    <li><a href="xstudinsidegrp.php?gname=<? echo "$gname" ?>"><i class="fa fa-th-large"></i>Workspace</a></li>

    <li><a href="#"><i class="fa fa-question-circle"></i>Tests</a>
             <ul class="sublist">
              <li><a href="xstudsubmittest.php?gname=<? echo "$gname" ?>">Submit</a></li>
              <li><a href="xstuddeltest.php?gname=<? echo "$gname" ?>">Remove</a></li>
             </ul>
    </li>

   <li><a href="#"><i class="fa fa-pencil-square"></i>To-Do</a>
             <ul class="sublist">
              <li><a href="xstudsubmitassign.php?gname=<? echo "$gname" ?>">Submit</a></li>
              <li><a href="xstuddelassign.php?gname=<? echo "$gname" ?>">Remove</a></li>
             </ul>
    </li> 

   <li><a href="xstudviewgstud.php?gname=<? echo "$gname" ?>"><i class="fa fa-users"></i>Students</a>
    </li> 
  ...
  <div class="sidebar">
    ...
    <ul>
      ...
      <li><a href="xstudviewmark.php?gname=<? echo "$gname" ?>"><i class="fa fa-graduation-cap"></i>Marks</a></li>
        <li><a href="xstudviewtestcal.php?gname=<? echo "$gname" ?>&gid=<? echo "$grpr2[0]" ?>"><i class="fa fa-calendar"></i>Calendar</a></li>
    </ul>
  </div>
