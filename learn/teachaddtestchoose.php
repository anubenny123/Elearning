  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="formspace">
        <br><br>
      <div class="deptform">
          <b><h1>Choose One Option to Conduct Exams</h1></b>
          <br><br>
...
<?php
 ...
 if(isset($_POST['optiontestsubmit']))
 {
    ...
    else
   {
    ...
    {
      echo '<script>location.href="teachaddnewtest.php?gname='.$gname.'"</script>';
    }
    else if($optiontest=="midtest")
    {
       echo '<script>location.href="teachaddmidtest.php?gname='.$gname.'"</script>'; 
    }
    else
    {
