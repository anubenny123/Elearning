...
<?php
 ...
 if($file==NULL)
 {
  $sql1="INSERT INTO tblTest(testgid,testname,testdesc,testdate,teststarttime,testendtime,testmax,teststatus)VALUES('$grpr2[0]','$testname','$testdesc','$testdate','$teststarttime','$testendtime','$testmax',1)";

  if($conn->query($sql1)===TRUE)
    echo '<script>var choice=confirm("Test Scheduled Successfully.Do You want to add More Events?");
  if(choice==true){location.href="teachaddnewtest.php?gname='.$gname.'"}else{ location.href="insidegrp.php?gname='.$gname.'"}</script>';
...
$sql="INSERT INTO tblTest(testgid,testname,testdesc,testdate,teststarttime,testendtime,testmax,qpaper,qpaperpath,teststatus)VALUES('$grpr2[0]','$testname','$testdesc','$testdate','$teststarttime','$testendtime','$testmax','$file','$filepath',1)";
