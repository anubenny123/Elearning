...
<body>
  ...
  <div class="nav">
   ...
   <li><a href="#"><i class="fa fa-users"></i>Students</a>
             <ul class="sublist">
              <li><a href="xtutordelgstud.php?gname=<? echo "$gname" ?>">Delete</a></li>
              <li><a href="xtutorviewgstud.php?gname=<? echo "$gname" ?>">View</a></li>
             </ul>
    </li> 
  
    <li><a href="#"><i class="fa fa-reply"></i>Responses</a>
        <ul class="sublist">
          <li><a href="xtutorviewtestresponse.php?gname=<? echo "$gname" ?>">Tests</a></li>
          <li><a href="xtutorviewassignresponse.php?gname=<? echo "$gname" ?>">To-Do</a></li>
        </ul>
    </li>  
