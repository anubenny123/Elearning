...
<div class="tabContainer">
    ...
    <?php
      ...
      $sql="SELECT testname,testdesc,testdate,teststarttime,testendtime,testmax,qpaper,CONCAT(CONCAT(testdate,' '),teststarttime) FROM tblTest where testgid='$grpr2[0]' AND teststatus=1 ORDER BY CONCAT(CONCAT(testdate,' '),teststarttime) DESC";
      $result=$conn->query($sql);
