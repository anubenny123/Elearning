 				  ...
 				  <div class="form-group">
                    ...
                    <select name="txtdel_grp" class="form-control" required>
                        ...
                        $r=mysqli_fetch_array($instrslt);
                          ...
                          $sql="SELECT gid,gname from tblGroup where gstatus=1 AND ginstemail='$r[0]' AND g_host_email='$uid'";
...
<?php
 ...
 if(isset($_POST['grp_submit']))
 {
  ...
  else
  {
    ...
    $sql="UPDATE tblGroup set gstatus=-1 where gid='$del_grp' AND gstatus=1 AND ginstemail='$r[0]' AND g_host_email='$uid'";
   // echo $sql;
  
    if($conn->query($sql)==TRUE)
    {
     echo '<script>alert("One Group Deleted Successfully")</script>';
     echo '<script>location.href="teachview_grpallexists.php"</script>';
    }
